<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Médico<small><i class="glyphicon glyphicon-chevron-right"></i> lista de médicos</small></h2>
    </div>
</div>
<div class="row">
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div>
					<table class="table table-striped table-bordered table-hover" id="tbl-lista-medico" width="100%">
						<thead>
							<tr>
